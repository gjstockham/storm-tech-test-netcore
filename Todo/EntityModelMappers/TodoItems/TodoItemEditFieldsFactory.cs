namespace Todo.EntityModelMappers.TodoItems
{
    ...
    public static class TodoItemEditFieldsFactory
    {
        public static TodoItemEditFields Create(TodoItem todoItem)
        {
            ...
            return new TodoItemEditFields(todoList.TodoListId, todoList.Title, todoItem.TodoItemId, todoItem.Title, todoItem.IsDone, todoItem.ResponsiblePartyId, todoItem.Importance);
        }
